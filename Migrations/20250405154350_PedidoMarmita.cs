...
{
    /// <inheritdoc />
    public partial class PedidoMarmita : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PedidoMarmita", x => new { x.PedidoId, x.MarmitaId });
                    table.ForeignKey(
                        name: "FK_PedidoMarmita_Marmita_MarmitaId",
                        column: x => x.MarmitaId,
                        principalTable: "Marmita",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PedidoMarmita_Pedido_PedidoId",
                        column: x => x.PedidoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PedidoMarmita_MarmitaId",
                table: "PedidoMarmita",
                column: "MarmitaId");
        }
